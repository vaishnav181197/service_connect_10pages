...
export default function AdsList101({ }) {
  ...
  return (
    <div className="min-h-screen py-2 bg-gray-200 ">
        ...
        <div className="flex items-center bg-[#787574] text-white rounded-full shadow-md w-[90%] sm:w-[80%] md:w-[60%] mx-auto px-1 py-1">
          {options.map((option) => (
            <button
              ...
              className={`flex-1 py-2 text-center text-sm sm:text-base font-medium rounded-full transition-all duration-300 ${selected === option
